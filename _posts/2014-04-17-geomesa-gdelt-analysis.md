...
{% highlight bash %}
cp geomesa-plugin/target/geomesa-plugin-{{ site.stableVersion }}-geoserver-plugin.jar /path/to/tomcat/webapps/geoserver/WEB-INF/lib/geomesa-plugin-{{ site.stableVersion }}-geoserver-plugin.jar
{% endhighlight %}
