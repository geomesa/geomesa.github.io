...
If you haven't already [read through the Quickstart tutorial](http://www.geomesa.org/2014/05/28/geomesa-quickstart/) and
...
Now, when users query the GeoMesa, or when data are read out of Accumulo by GeoServer, only users with the correct level of authorization will be able to read the feature.
...
This tutorial has real-world use cases in security and data integrity. For example, when storing data at differing classification levels in the same database, and having users at varying levels of security,
this ensures that sensitive data is not leaked to a user of a lower level of security.
...
If you're interested in learning more about this, feel free to email [jdk2pq@ccri.com](mailto:jdk2pq@ccri.com).
